...
ven_fingerprint_real=`echo "$temp" | grep -F "ro.vendor.build.fingerprint_real=" -m 1 | cut -d'=' -f2` && \
ven_fingerprint=`echo "$temp" | grep -F "ro.vendor.build.fingerprint=" -m 1 | cut -d'=' -f2` && \
[ -n "$ven_fingerprint_real" ] && resetprop "ro.vendor.build.fingerprint" "$ven_fingerprint_real" || resetprop "ro.vendor.build.fingerprint" "$ven_fingerprint" &
...
sleep 2
ven_fingerprint=`getprop ro.vendor.build.fingerprint`
RELEASE=`getprop "ro.build.version.release" | cut -d'.' -f1`
[ -n "$ven_fingerprint" -a "$RELEASE" -ge "10" ] && resetprop "ro.build.fingerprint" "$ven_fingerprint"
